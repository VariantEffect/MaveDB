    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.CharField(default=None, max_length=256, verbose_name='Target Gene')),
                ...
                ('doi_ids', models.ManyToManyField(blank=True, to='metadata.DoiIdentifier', verbose_name='DOI Identifiers')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doi_ids', models.ManyToManyField(blank=True, to='metadata.DoiIdentifier', verbose_name='DOI Identifiers')),
                ('keywords', models.ManyToManyField(blank=True, to='metadata.Keyword', verbose_name='Keywords')),
                ...
                ('pmid_ids', models.ManyToManyField(blank=True, to='metadata.PubmedIdentifier', verbose_name='PubMed Identifiers')),
                ('sra_ids', models.ManyToManyField(blank=True, to='metadata.SraIdentifier', verbose_name='SRA Identifiers')),
            ],
            options={
