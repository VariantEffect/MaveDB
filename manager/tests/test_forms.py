...
class TestAddPmidForm(TestCase):
    def test_field_validation(self):
        ...
        urn = ''
        pmid = ''
        form = forms.AddPmidForm(data={
            urn_field_name: urn,
            pmid_field_name: pmid
        })
        self.assertTrue('This field is required.' in form.errors[urn_field_name])
        self.assertTrue('This field is required.' in form.errors[pmid_field_name])
        ...
        self.assertTrue(f"{pmid} is not a valid PubMed identifier." in form.errors[pmid_field_name])
...
class TestAddUserForm(TestCase):
    def test_field_validation(self):
        ...
        self.assertTrue('This field is required.' in form.errors[message_field_name])
        self.assertTrue('This field is required.' in form.errors[level_field_name])
        ...
        self.assertTrue(f"Invalid level {level}." in form.errors[level_field_name])
