...
LOGGING = {
    ...
    "handlers": {
        "file": {
            ...
            "filename": "/var/log/mavedb/ci/mavedb.log",
            "formatter": "verbose",
        },
        "celery": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/var/log/mavedb/ci/celery.log",
            "formatter": "verbose",
        },
        "core.tasks": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/var/log/mavedb/ci/celery_core_tasks.log",
            "formatter": "verbose",
        },
        "accounts.tasks": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/var/log/mavedb/ci/celery_accounts_tasks.log",
            "formatter": "verbose",
        },
        "dataset.tasks": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/var/log/mavedb/ci/celery_dataset_tasks.log",
            "formatter": "verbose",
        },
    },
    "loggers": {
