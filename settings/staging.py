...
LOGGING = {
    ...
    "handlers": {
        "file": {
            ...
            "filename": "/usr/local/share/web/mavedb/logs/mavedb.log",
            "formatter": "verbose",
        },
        "celery": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/usr/local/share/web/mavedb/logs/celery.log",
            "formatter": "verbose",
        },
        "core.tasks": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/usr/local/share/web/mavedb/logs/celery_core_tasks.log",
            "formatter": "verbose",
        },
        "accounts.tasks": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/usr/local/share/web/mavedb/logs/celery_accounts_tasks.log",
            "formatter": "verbose",
        },
        "dataset.tasks": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/usr/local/share/web/mavedb/logs/celery_dataset_tasks.log",
            "formatter": "verbose",
        },
    },
    "loggers": {
