...
LOGGING = {
    ...
    "handlers": {
        "file": {
            ...
            "filename": "/usr/local/webapps/logs/test/mavedb.log",
            "formatter": "verbose",
        },
        "celery": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/usr/local/webapps/logs/test/celery.log",
            "formatter": "verbose",
        },
        "core.tasks": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/usr/local/webapps/logs/test/celery_core_tasks.log",
            "formatter": "verbose",
        },
        "accounts.tasks": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/usr/local/webapps/logs/test/celery_accounts_tasks.log",
            "formatter": "verbose",
        },
        "dataset.tasks": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": "/usr/local/webapps/logs/test/celery_dataset_tasks.log",
            "formatter": "verbose",
        },
    },
    "loggers": {
        "django": {"handlers": ["file"], "level": "DEBUG", "propagate": False},
        "celery": {
            "handlers": ["celery"],
            "level": "DEBUG",
            "propagate": True,
