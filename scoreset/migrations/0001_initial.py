    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset_columns', django.contrib.postgres.fields.jsonb.JSONField(default={'counts': [], 'scores': []}, validators=[scoreset.validators.valid_json_field], verbose_name='Dataset columns')),
                ('experiment', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.PROTECT, to='experiment.Experiment')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('accession', models.CharField(default=None, max_length=64, unique=True, validators=[scoreset.validators.valid_var_accession], verbose_name='Accession')),
                ('creation_date', models.DateField(default=datetime.date.today, verbose_name='Creation date')),
                ('hgvs_string', models.TextField(default=None, null=True, validators=[scoreset.validators.valid_hgvs_string])),
                ('data', django.contrib.postgres.fields.jsonb.JSONField(default={'counts': {}, 'scores': {}}, validators=[scoreset.validators.valid_json_field], verbose_name='Data columns')),
