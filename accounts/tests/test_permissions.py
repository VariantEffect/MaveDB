...
#     remove_user_as_instance_author,
...
#
#     def test_can_get_author_group_name_for_instance(self):
#         group_name = get_author_group_name_for_instance(self.exps)
#         self.assertEqual(group_name, 'urn:mavedb:00000001-author')
#
...
#         )
#
#     def test_can_make_author_group_for_instance(self):
#         create_author_group_for_instance(self.instance)
#         self.assertEqual(Group.objects.count(), 1)
#         self.assertEqual(
#             Group.objects.all()[0].name,
#             '{}-{}'.format(self.instance.urn, GroupTypes.AUTHOR)
#         )
#
...
#         )
#
#     def test_can_delete_author_group_for_instance(self):
#         self.assertEqual(Group.objects.count(), 3)
#         group_name = delete_author_group_for_instance(self.instance)
#         self.assertEqual(Group.objects.count(), 2)
#         self.assertEqual(
#             group_name,
#             '{}-{}'.format(self.instance.urn, GroupTypes.AUTHOR)
...
#         self.assertFalse(can_view)
#
#     def test_correct_permissions_assigned_to_author_group(self):
#         user = self.user()
#         assign_user_as_instance_author(user, self.instance_1)
#         can_manage = user.has_perm(PermissionTypes.CAN_MANAGE, self.instance_1)
#         can_edit = user.has_perm(PermissionTypes.CAN_EDIT, self.instance_1)
#         can_view = user.has_perm(PermissionTypes.CAN_VIEW, self.instance_1)
#         self.assertFalse(can_manage)
...
#         self.assertTrue(can_view)
#
#     def test_author_permissions_removed_when_removing_user(self):
#         user = self.user()
#         assign_user_as_instance_author(user, self.instance_1)
#         remove_user_as_instance_author(user, self.instance_1)
#         can_manage = user.has_perm(PermissionTypes.CAN_MANAGE, self.instance_1)
#         can_edit = user.has_perm(PermissionTypes.CAN_EDIT, self.instance_1)
#         can_view = user.has_perm(PermissionTypes.CAN_VIEW, self.instance_1)
#         self.assertFalse(can_manage)
...
#         self.assertFalse(user_is_admin_for_instance(user, self.instance_1))
#         self.assertFalse(
#             user_is_author_for_instance(user, self.instance_1))
...
#         self.assertTrue(user_is_admin_for_instance(user, self.instance_1))
#
#     def test_can_assign_user_as_author(self):
#         user = self.user()
#         assign_user_as_instance_author(user, self.instance_1)
#         self.assertTrue(user_is_author_for_instance(user, self.instance_1))
#
...
#         self.assertFalse(user_is_admin_for_instance(user, self.instance_1))
#
#     def test_can_remove_user_from_author_group(self):
#         user = self.user()
#         assign_user_as_instance_author(user, self.instance_1)
#         self.assertTrue(user_is_author_for_instance(user, self.instance_1))
#
#         remove_user_as_instance_author(user, self.instance_1)
#         self.assertFalse(user_is_author_for_instance(user, self.instance_1))
#
...
#         self.assertTrue(user_is_admin_for_instance(alice, self.instance_1))
#
#     def test_update_admin_author_empty_list_removes_all(self):
#         bob = User.objects.create(username="bob")
#         alice = User.objects.create(username="alice")
#         assign_user_as_instance_author(bob, self.instance_1)
#         assign_user_as_instance_author(alice, self.instance_1)
#
#         self.assertTrue(user_is_author_for_instance(bob, self.instance_1))
#         self.assertTrue(user_is_author_for_instance(alice, self.instance_1))
#
#         update_author_list_for_instance([], self.instance_1)
#         self.assertFalse(user_is_author_for_instance(bob, self.instance_1))
#         self.assertFalse(user_is_author_for_instance(alice, self.instance_1))
#
#     def test_can_update_author_group_with_user_list(self):
#         bob = User.objects.create(username="bob")
#         alice = User.objects.create(username="alice")
#         assign_user_as_instance_author(bob, self.instance_1)
#         assign_user_as_instance_author(alice, self.instance_1)
...
#         self.assertTrue(user_is_author_for_instance(alice, self.instance_1))
#
#         update_author_list_for_instance([alice], self.instance_1)
#         self.assertFalse(user_is_author_for_instance(bob, self.instance_1))
#         self.assertTrue(user_is_author_for_instance(alice, self.instance_1))
#
...
#
#         assign_user_as_instance_admin(alice, self.instance_1)
#         assign_user_as_instance_author(farva, self.instance_1)
#         assign_user_as_instance_viewer(bob, self.instance_1)
#
